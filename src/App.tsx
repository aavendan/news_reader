...
import { ellipse, square, triangle, newspaperOutline, cloudDownloadOutline, searchOutline } from 'ionicons/icons';
    ...
    <IonReactRouter>
      <IonTabs>
        ...
        <IonTabBar slot="bottom">
          ...
          <IonTabButton tab="tab2" href="/news_reader">
